...
public class Tetromino {
    ...
    public static final int TETROMINO_MATRIX_SIZE = 4; // If this value is changed, every matrix MUST be changed to a
                                                       // TETROMINIO_MATRIX_SIZE x TETROMINIO_MATRIX_SIZE matrix
    ...
    public int[][] getCurrentTetromino() {
    ...
    public boolean isAlive() {
        return (this.yPos
                - Tetromino.TETROMINO_BLOCK_SIZE * getMatrixRowsWithoutBlocksOnDownHalf() < Board.BOARD_HEIGHT_IN_BLOCKS
